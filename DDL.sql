...
CREATE TABLE match.match (
  ...
  team_list_idx INT REFERENCES team.list(team_list_idx) ON DELETE SET NULL,
...
CREATE TABLE match.team_stats (
  ...
  team_list_idx INT,
  team_list_name VARCHAR(20) NOT NULL,
  match_team_stats_our_score INT NOT NULL DEFAULT 0 CHECK (match_team_stats_our_score >= 0),
  match_team_stats_other_score INT NOT NULL DEFAULT 0 CHECK (match_team_stats_other_score >= 0),
  match_team_stats_possession FLOAT NOT NULL DEFAULT 0 CHECK (match_team_stats_possession BETWEEN 0 AND 100),
  match_team_stats_total_shot INT NOT NULL DEFAULT 0 CHECK (match_team_stats_total_shot >= 0),
  match_team_stats_expected_goal FLOAT NOT NULL DEFAULT 0 CHECK (match_team_stats_expected_goal >= 0),
  match_team_stats_total_pass INT NOT NULL DEFAULT 0 CHECK (match_team_stats_total_pass >= 0),
  match_team_stats_total_tackle INT NOT NULL DEFAULT 0 CHECK (match_team_stats_total_tackle >= 0),
  match_team_stats_success_tackle INT NOT NULL DEFAULT 0 CHECK (match_team_stats_success_tackle >= 0),
  match_team_stats_saved INT NOT NULL DEFAULT 0 CHECK (match_team_stats_saved >= 0),
  match_team_stats_cornerkick INT NOT NULL DEFAULT 0 CHECK (match_team_stats_cornerkick >= 0),
  match_team_stats_freekick INT NOT NULL DEFAULT 0 CHECK (match_team_stats_freekick >= 0),
  match_team_stats_penaltykick INT NOT NULL DEFAULT 0 CHECK (match_team_stats_penaltykick >= 0),
  match_team_stats_evidence_img JSONB,
  CONSTRAINT unique_match_team UNIQUE (match_match_idx, team_list_idx)
);
...
CREATE TABLE match.player_stats (
  ...
  match_player_stats_goal INT NOT NULL DEFAULT 0 CHECK (match_player_stats_goal >= 0),
  match_player_stats_assist INT NOT NULL DEFAULT 0 CHECK (match_player_stats_assist >= 0),
  match_player_stats_successrate_pass FLOAT NOT NULL DEFAULT 0 CHECK (match_player_stats_successrate_pass BETWEEN 0 AND 100),
  match_player_stats_successrate_dribble FLOAT NOT NULL DEFAULT 0 CHECK (match_player_stats_successrate_dribble BETWEEN 0 AND 100),
  match_player_stats_successrate_tackle FLOAT NOT NULL DEFAULT 0 CHECK (match_player_stats_successrate_tackle BETWEEN 0 AND 100),
  match_player_stats_possession FLOAT NOT NULL DEFAULT 0 CHECK (match_player_stats_possession BETWEEN 0 AND 100),
  match_player_stats_standing_tackle INT NOT NULL DEFAULT 0 CHECK (match_player_stats_standing_tackle >= 0),
  match_player_stats_sliding_tackle INT NOT NULL DEFAULT 0 CHECK (match_player_stats_sliding_tackle >= 0),
